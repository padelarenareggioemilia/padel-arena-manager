-- PADEL ARENA MANAGER V8.2.38.54
-- Espone alla pagina pubblica la scelta dell'admin sulle iscrizioni singole.
-- Non modifica e non cancella tornei, giocatori, coppie, partite o risultati.
...
begin
  ...
  return jsonb_build_object(
    ...
    'logo_url',coalesce(t.logo_url,d->>'logoUrl'),
    ...
    'waitlist_enabled',coalesce(nullif(d->>'waitlistEnabled','')::boolean,true),
    'allow_single_registration',coalesce(nullif(d->>'allowSingleRegistration','')::boolean,true),
